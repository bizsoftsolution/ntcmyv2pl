...
const EXAMPLE_DATA: PropertyTableItem[] = [
  {id: 1, name: 'Hydrogen'},
  {id: 2, name: 'Helium'},
  {id: 3, name: 'Lithium'},
  {id: 4, name: 'Beryllium'},
...
export class PropertyTableDataSource extends DataSource<PropertyTableItem> {
  data: PropertyTableItem[] = EXAMPLE_DATA;
   ...
   */
  private getPagedData(data: PropertyTableItem[]) {
   ...
   * this would be replaced by requesting the appropriate data from the server.
   */
  private getSortedData(data: PropertyTableItem[]) {
